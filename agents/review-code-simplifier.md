---
description: "Code simplifier — suggests semantics-preserving opportunities to reduce unnecessary complexity in orchestrator pipeline changes."
mode: subagent
hidden: true
temperature: 0.1
steps: 25
...
HIGH and MEDIUM findings are the only ones the fix loop will act on. LOW and 💡 remain pure advisory notes. Status is always `PASS`.
