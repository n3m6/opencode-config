---
description: "Silent-failure reviewer — checks orchestrator pipeline changes for swallowed errors, unsafe fallbacks, missing error paths, and partial-failure risks."
mode: subagent
hidden: true
temperature: 0.1
steps: 25
